...
_CRYPTO_EXCHANGES = [
    _s(
        ...
        category=Category.CRYPTO_EXCHANGE,
        assets=CRYPTO,
        apis=("rest", "websocket"),
        auth="jwt_cdp",
        capabilities=("spot", "data"),
        adapter="coinbase",
        sdk="coinbase-advanced-py",
    ...
    _s(
        ...
        assets=CRYPTO,
        apis=("rest", "websocket"),
        capabilities=("spot", "margin", "data"),
        adapter="ccxt",
        sdk="ccxt / python-kraken-sdk",
    ...
    _s(
        ...
        capabilities=("spot", "margin", "data"),
        adapter="ccxt",
        sdk="ccxt / python-binance",
        notes="Heavy regional restrictions; see Binance.US.",
    ),
    _s(
        id="binanceus",
        name="Binance.US",
    ...
    _s(
        ...
        assets=CRYPTO,
        apis=("rest", "websocket"),
        capabilities=("spot", "derivatives", "data"),
        adapter="ccxt",
        sdk="ccxt / pybit",
    ),
    _s(
...
_CRYPTO_DERIVS = [
    _s(
        id="deribit",
        name="Deribit",
        category=Category.CRYPTO_DERIVATIVES,
        assets=CRYPTO,
        apis=("rest", "websocket"),
        capabilities=("options", "futures", "data"),
        adapter="ccxt",
        sdk="ccxt",
        notes="Reference venue for crypto options.",
    ),
    _s(
        id="bitmex",
        name="BitMEX",
...
_CRYPTO_DEX = [
    _s(
        id="hyperliquid",
        name="Hyperliquid",
        category=Category.CRYPTO_DEX,
        assets=CRYPTO,
        apis=("rest", "websocket"),
        auth="wallet",
        capabilities=("perps", "data"),
        adapter="ccxt",
        sdk="ccxt / hyperliquid-python-sdk",
        notes="On-chain perpetuals.",
    ),
    _s(
        id="dydx",
        name="dYdX",
...
_BROKERS = [
    _s(
        ...
        assets=(AssetClass.EQUITY, AssetClass.ETF, AssetClass.OPTION, AssetClass.CRYPTO),
        apis=("rest", "websocket"),
        auth="api_key",
        capabilities=("spot", "options", "paper", "data"),
        adapter="alpaca",
        sdk="built-in (stdlib) / alpaca-py",
        docs="https://docs.alpaca.markets/",
        notes="Bundled adapter. Set ALPACA_API_KEY_ID/ALPACA_API_SECRET_KEY; paper sandbox by default.",
    ),
    _s(
        id="ibkr",
        ...
        apis=("rest", "fix"),
        capabilities=("spot", "options", "futures", "forex", "data"),
        adapter=None,
        sdk="ib_insync / ib_async",
        notes="Widest global asset coverage.",
    ),
    _s(
        id="tradier",
        name="Tradier",
        category=Category.BROKER,
        assets=(AssetClass.EQUITY, AssetClass.OPTION),
        capabilities=("spot", "options", "data"),
        adapter=None,
        sdk="REST",
    ),
    _s(
        ...
        name="tastytrade",
        category=Category.BROKER,
        assets=(AssetClass.EQUITY, AssetClass.OPTION, AssetClass.FUTURE),
        capabilities=("options",),
        adapter=None,
    ),
    _s(
        id="schwab",
        name="Charles Schwab (ex-TD Ameritrade)",
        category=Category.BROKER,
        assets=STOCK,
        capabilities=("spot", "options", "data"),
        adapter=None,
        notes="Absorbed thinkorswim/TDA API.",
    ),
    _s(
        id="tradestation",
        name="TradeStation",
    ...
    _s(
        ...
        name="Robinhood",
        category=Category.BROKER,
        assets=(AssetClass.CRYPTO, AssetClass.EQUITY),
        capabilities=("spot",),
        adapter=None,
        notes="Official crypto trading API.",
    ),
    ...
    _s(
        ...
        category=Category.BROKER,
        assets=STOCK,
        capabilities=("spot", "options"),
        adapter=None,
    ),
    _s(
        id="moomoo",
        name="Moomoo / Futu OpenAPI",
        category=Category.BROKER,
        assets=STOCK,
        capabilities=("spot", "options", "data"),
        adapter=None,
    ...
    _s(
        ...
        category=Category.BROKER,
        assets=STOCK,
        capabilities=("spot", "aggregator"),
        adapter=None,
        notes="One API routing to many retail brokers.",
    ),
]
...
_FOREX = [
    _s(
        id="oanda",
        name="OANDA",
        category=Category.FOREX_CFD,
        assets=FX,
        apis=("rest", "websocket"),
        capabilities=("forex", "cfd", "data", "paper"),
        adapter=None,
        sdk="oandapyV20",
    ...
    _s(
        ...
        capabilities=("forex", "cfd"),
        adapter=None,
        sdk="MetaTrader5 (Python)",
        notes="Dominant retail FX/CFD automation stack; broker-provided.",
    ),
    _s(
        id="ctrader",
...
_FUTURES = [
    _s(
        ...
        adapter=None,
        notes="Accessed via brokers/ISVs over FIX.",
    ),
    _s(
        id="ice",
        name="ICE",
    ...
    _s(
        id="tt",
        name="Trading Technologies (TT API)",
        category=Category.FUTURES,
        assets=(AssetClass.FUTURE,),
        capabilities=("futures", "oms"),
        adapter=None,
    ),
]
...
_AGGREGATORS = [
    _s(
        ...
        notes="One interface to 100+ crypto exchanges.",
    ),
    _s(
        id="hummingbot",
        name="Hummingbot",
        category=Category.AGGREGATOR,
        assets=CRYPTO,
        capabilities=("market_making", "arbitrage"),
        adapter=None,
    ),
    _s(
        id="cryptofeed",
...
_FRAMEWORKS = [
    _s(
        ...
        capabilities=("backtest", "live", "multi_broker"),
        adapter=None,
        docs="https://www.quantconnect.com/",
    ),
    _s(
        id="nautilus",
        name="NautilusTrader",
    ...
    _s(
        ...
        category=Category.FRAMEWORK,
        assets=CRYPTO,
        capabilities=("backtest", "live", "bot"),
        adapter=None,
    ),
    _s(
        id="jesse",
...
_BOTS = [
    _s(
        id="3commas",
        name="3Commas",
        category=Category.BOT_PLATFORM,
        assets=CRYPTO,
        capabilities=("bot", "copy"),
        adapter=None,
    ),
    _s(
        id="cryptohopper",
    ...
    _s(
        id="bitsgap", name="Bitsgap", category=Category.BOT_PLATFORM, assets=CRYPTO, capabilities=("bot",), adapter=None
    ),
    _s(
        id="composer",
        name="Composer",
...
_COPY = [
    _s(
        ...
        assets=(AssetClass.EQUITY, AssetClass.CRYPTO),
        capabilities=("copy",),
        adapter=None,
    ),
    _s(
...
_INFRA = [
    _s(
        ...
        category=Category.BROKER_INFRA,
        assets=STOCK,
        capabilities=("embedded_brokerage",),
        adapter=None,
    ),
    _s(
        id="drivewealth",
    ...
    _s(
        ...
        category=Category.BROKER_INFRA,
        assets=CRYPTO,
        capabilities=("custody", "execution"),
        adapter=None,
    ),
    _s(
        id="talos",
...
_NOTIFIERS = [
    _s(
        id="console",
        name="Console / stdout",
        category=Category.NOTIFIER,
        auth="none",
        capabilities=("notify",),
        adapter="console",
        notes="Always available; prints confirmations.",
    ),
    _s(
        id="webhook",
        ...
        capabilities=("notify",),
        adapter="webhook",
        notes="POST JSON to any URL (Slack/Discord/Telegram/custom).",
    ),
    _s(
        id="slack",
        name="Slack",
...
_SECRETS = [
    _s(
        id="aws_secrets", name="AWS Secrets Manager", category=Category.SECRETS, capabilities=("secrets",), adapter=None
    ),
...
_PAPER = [
    _s(
        ...
        category=Category.CRYPTO_EXCHANGE,
        assets=(AssetClass.CRYPTO, AssetClass.EQUITY, AssetClass.ETF),
        apis=("local",),
        auth="none",
        capabilities=("spot", "paper", "data"),
        adapter="paper",
        sdk="built-in",
